...
const Faqs = () => {
  ...
  return (
    <div className="playfair-display-letras mx-auto max-w-6xl p-2 rounded bg-[#262626]  ">
      <div className="flex justify-center items-center flex-col mt-5">
        <h2 className="lg:text-4xl md:text-4xl text-3xl font-extrabold mb-4 lg:!leading-[55px] sm:text-4xl sm:leading-tight text-[#d3d3cb]">
        ...
        <div className="w-full max-w-xs relative text-gray-600">
          <input
            ...
            name="search"
            placeholder="Buscar"
            className="bg-[#d3d3cb] w-full h-8 px-6 rounded-full text-sm focus:outline-none"
          />
          <button
            type="submit"
            ...
            .map((item, index) => (
              <div key={index} className="p-4">
                <div className="item">
                  ...
                  {openIndex === index && (
                    <div className="mt-3 text-[#d3d3cb]">
                      <p>{item.answer}</p>
                    </div>
                  )}
                </div>
